        ...
        <footer id='footer' className='text-white' style={{ backgroundColor: '#123F1E' }}>
                    ...
                    <div className='lg:col-auto md:col sm:col-span-3 col xl:space-y-3.5 space-y-2'>
                        ...
                        <div className='sm:space-y-2 space-y-1.5 xl:text-base text-sm'>
                            ...
                            <a className='block text-sm sm:text-base hover:underline' href="tel:+1 (406) 555-0120">
                                <Phone fontSize='inherit' /> +91 6263186037
                            </a>

                            {/* Email */}
                            <a className='block text-sm sm:text-base hover:underline' href="mailto:deependra186037@gmail.com">
                                <Mail fontSize='inherit' /> developer@gmail.com
                            </a>

                            {/* Address (fake)*/}
                            <address>
                                <LocationOn fontSize='inherit' />123 Main Street, M.P.
                            </address>
                        </div>
                    </div>
                </div>
            ...
            <div>
                ...
                <div className='text-center flex items-center h-12'>
                    <span className='text-xs  w-full block text-gray-300 tracking-wider'>© 2024 Developed By <a className='hover:underline' href="https://github.com/Deep1416" target="_blank" rel="noopener noreferrer"> Deependra </a></span>
                </div>
            </div>
        </footer>
    );
